...
parser = argparse.ArgumentParser(description="Z-Image + BC + MGR (Aircraft)")
...
DATASET_CONFIG = {
    ...
    "output_path": "results/ZImage_BC_MGR_Aircraft"
}
...
if __name__ == "__main__":
    ...
    for class_name in tqdm(my_classes):
        ...
        while retry_cnt < args.max_retries:
            ...
            # Retrieve top-K (e.g., 5) to allow filtering
    ...
    # Global Memory Training (Optional, but part of MGR script)
    print("\n============================================")
