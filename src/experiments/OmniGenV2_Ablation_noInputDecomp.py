...
def importance_aware_input_interpreter(prompt, client, model="gpt-4o", domain="aircraft"):
    # ABLATION: noInputDecomp
    # Skip VLM decomposition. Use raw prompt for everything.
    return {
        "high_importance": {"entity": prompt, "key_features": []},
        "low_importance": {},
        "importance_weights": {},
...
if __name__ == "__main__":
    ...
    DATASET_CONFIG = {
        ...
        "output_path": f"results/{_rm}/{timestamp}/OmniGenV2_Ablation_noInputDecomp_{run_time}",
    }
