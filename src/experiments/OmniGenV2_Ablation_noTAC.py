...
if __name__ == "__main__":
    ...
    DATASET_CONFIG = {
        ...
        "output_path": f"results/{_rm}/{timestamp}/OmniGenV2_Ablation_noTAC_{run_time}",
    }
    ...
    for class_idx, class_name in enumerate(tqdm(my_tasks, desc="5-Step Pipeline")):
        ...
        try:
            ...
            # ABLATION: noTAC
            # Skip TAC Diagnosis and skip Step 5 (Reflexive Re-generation).
            # Force the score to 10.0 to guarantee it passes the loop threshold immediately.
            f_log.write(">>> STEP 4 & 5 ABLATION: Skipping TAC and Retry. Forcing acceptance of first generation.\n")
            score = 10.0
            best_score = 10.0
            best_image_path = v1_path
            ...
            if score < args.tac_pass_threshold:
                ...
                while retry_cnt < 0: # ABLATION: Force skip loop
                    retry_cnt += 1
