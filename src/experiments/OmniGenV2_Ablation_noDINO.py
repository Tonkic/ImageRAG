...
def dino_injected_generation(pipe, generation_prompt, ref_image_path,
    ...
    # ABLATION: noDINO
    # Skip DINO structural similarity entirely.
    log(f"  [Step3-DINO ABLATION] Skipping DINO feature extraction. Using base guidance scale.")
    effective_img_guidance = img_guidance_scale
...
if __name__ == "__main__":
    ...
    DATASET_CONFIG = {
        ...
        "output_path": f"results/{_rm}/{timestamp}/OmniGenV2_Ablation_noDINO_{run_time}",
    }
