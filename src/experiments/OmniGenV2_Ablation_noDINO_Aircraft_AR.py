...
def dino_injected_generation(pipe, generation_prompt, ref_image_path,
                              ...
                              dino_ref_path=None):
    """
    Stage 3: Generate image WITHOUT DINOv3 structural prior injection (Ablation).
    The reference image is still passed to OmniGen for AR early fusion,
    but DINO logic is bypassed and image_guidance_scale remains constant.
    ...
    # [Ablation] DINO structure prior is disabled.
    effective_img_guidance = img_guidance_scale
    log(f"  [Step3-ABLATION] DINO structural prior disabled. Using base guidance: {effective_img_guidance:.3f}")
...
if __name__ == "__main__":
    ...
    DATASET_CONFIG = {
        ...
        "output_path": f"results/{_rm}/{timestamp}/OmniGenV2_Ablation_noDINO_AR_{run_time}",
    }
    ...
    for class_idx, class_name in enumerate(tqdm(my_tasks, desc="5-Step Pipeline")):
        ...
        try:
            ...
            # ==================================================================
            f_log.write(">>> STEP 3: Initial Generation (AR Base Only / No DINO Injection)\n")
