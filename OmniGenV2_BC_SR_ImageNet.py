...
Usage:
  python OmniGenV2_BC_SR_ImageNet.py \
      --device_id 0 \
      --task_index 0 \
      --total_chunks 1 \
...
# --- 1. Argument Parsing ---
parser = argparse.ArgumentParser(description="OmniGenV2 + BC + SR (ImageNet)")
...
DATASET_CONFIG = {
    ...
    "output_path": "results/OmniGenV2_BC_SR_ImageNet"
}
