'''
Evaluation Script for: OmniGenV2 + TAC + SR (Aircraft)
======================================================
Metrics:
...
# --- 1. Args ---
# --------------------------------------------------
parser = argparse.ArgumentParser(description="Evaluate OmniGenV2_TAC_SR_Aircraft")
...
DATASET_CONFIG = {
    ...
    "results_dir": "results/OmniGenV2_TAC_SR_Aircraft"
}
...
def main():
    ...
    print("\n" + "="*60)
    print(f"  EVAL REPORT: OmniGenV2 + TAC + SR (Aircraft)")
    print("="*60)
