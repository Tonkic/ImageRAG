...
# --- 1. Argument Parsing ---
parser = argparse.ArgumentParser(description="OmniGenV2 + BC + SR (Winoground)")
...
DATASET_CONFIG = {
    "output_path": "results/OmniGenV2_BC_SR_Winoground",
    ...
    for i in tqdm(my_indices):
        ...
        for suffix in ["0", "1"]:
            ...
            while retry_cnt < args.max_retries:
                ...
                best_ref = retrieved_lists[0][0] if retrieved_lists and retrieved_lists[0] else None
