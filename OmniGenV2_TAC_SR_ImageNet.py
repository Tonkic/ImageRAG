...
Usage:
  python OmniGenV2_TAC_SR_ImageNet.py \
      --device_id 0 \
      --task_index 0 \
      --total_chunks 1 \
...
# --- 1. Argument Parsing ---
parser = argparse.ArgumentParser(description="OmniGenV2 + TAC + SR (ImageNet)")
...
from retrieval import retrieve_img_per_caption # Retrieval (Static)
# ------------------------------------------------------------------
...
DATASET_CONFIG = {
    ...
    "output_path": "results/OmniGenV2_TAC_SR_ImageNet"
}
