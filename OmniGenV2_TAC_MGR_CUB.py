...
DATASET_CONFIG = {
    ...
    "output_path": f"results/{_rm}/{timestamp}/OmniGenV2_TAC_MGR_CUB_{run_time}"
}
...
if __name__ == "__main__":
    ...
    for class_name_raw in tqdm(my_classes):
        ...
        while retry_cnt < args.max_retries:
            ...
            # A. TAC Diagnosis
            diagnosis = taxonomy_aware_diagnosis(current_prompt, [current_image], client, args.llm_model, reference_specs=reference_specs, domain="cub")
