'''
Evaluation Script for: OmniGenV2 + TAC + MGR (ImageNet)
=======================================================
Metrics:
...
# --- 1. Args ---
# --------------------------------------------------
parser = argparse.ArgumentParser(description="Evaluate OmniGenV2_TAC_MGR_ImageNet")
...
DATASET_CONFIG = {
    ...
    "results_dir": "results/OmniGenV2_TAC_MGR_ImageNet"
}
...
def main():
    ...
    print("\n" + "="*60)
    print(f"  EVAL REPORT: OmniGenV2 + TAC + MGR (ImageNet)")
    print("="*60)
