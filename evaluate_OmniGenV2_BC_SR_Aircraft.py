'''
Evaluation Script for: OmniGenV2 + BC + SR (Aircraft)
=======================================================
Metrics:
...
# --- 1. Args ---
# --------------------------------------------------
parser = argparse.ArgumentParser(description="Evaluate OmniGenV2_BC_SR_Aircraft")
...
DATASET_CONFIG = {
    ...
    "results_dir": "results/OmniGenV2_BC_SR_Aircraft"
}
...
def main():
    ...
    print("\nComputing KID...")
    # Debug counts
    # Note: torchmetrics stores features in lists of tensors
    # n_real = sum(t.shape[0] for t in models['kid_v1'].real_features)
    # n_fake = sum(t.shape[0] for t in models['kid_v1'].fake_features)
    # print(f"KID V1 Samples: Real={n_real}, Fake={n_fake}")
    ...
    print("\n" + "="*60)
    print(f"  EVAL REPORT: OmniGenV2 + BC + SR (Aircraft)")
    print("="*60)
    ...
    show("BC+SR (Final)", scores_final, kfin)
    print("="*60)
