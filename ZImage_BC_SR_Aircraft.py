...
parser = argparse.ArgumentParser(description="Z-Image + BC + SR (Aircraft)")
...
DATASET_CONFIG = {
    ...
    "output_path": "results/ZImage_BC_SR_Aircraft"
}
...
def run_zimage(pipe, prompt, input_images, output_path, seed):
    # Strip RAG tokens as Z-Image is T2I
...
if __name__ == "__main__":
    ...
    for class_name in tqdm(my_classes):
        ...
        # Baseline logic (optional, keeping simple for now)
