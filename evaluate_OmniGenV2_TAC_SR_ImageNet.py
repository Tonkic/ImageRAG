'''
Evaluation Script for: OmniGenV2 + TAC + SR (ImageNet)
=======================================================
Metrics:
...
# --- 1. Args ---
# --------------------------------------------------
parser = argparse.ArgumentParser(description="Evaluate OmniGenV2_TAC_SR_ImageNet")
...
DATASET_CONFIG = {
    ...
    "results_dir": "results/OmniGenV2_TAC_SR_ImageNet"
}
...
# --------------------------------------------------
# --- 3. Data Loader (ImageNet Specific) ---
# --------------------------------------------------
...
def main():
    ...
    print("\n" + "="*60)
    print(f"  EVAL REPORT: OmniGenV2 + TAC + SR (ImageNet)")
    print("="*60)
    ...
    show("TAC+SR (Final)", scores_final, kfin)
    print("="*60)
