'''
Evaluation Script for: OmniGenV2 + BC + SR (ImageNet)
=======================================================
Metrics:
...
# --- 1. Args ---
# --------------------------------------------------
parser = argparse.ArgumentParser(description="Evaluate OmniGenV2_BC_SR_ImageNet")
...
DATASET_CONFIG = {
    ...
    "results_dir": "results/OmniGenV2_BC_SR_ImageNet"
}
...
def main():
    ...
    print("\n" + "="*60)
    print(f"  EVAL REPORT: OmniGenV2 + BC + SR (ImageNet)")
    print("="*60)
