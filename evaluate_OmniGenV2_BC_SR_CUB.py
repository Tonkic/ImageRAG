'''
Evaluation Script for: OmniGenV2 + BC + SR (CUB)
=======================================================
Metrics:
...
# --- 1. Args ---
# --------------------------------------------------
parser = argparse.ArgumentParser(description="Evaluate OmniGenV2_BC_SR_CUB")
...
DATASET_CONFIG = {
    ...
    "results_dir": "results/OmniGenV2_BC_SR_CUB"
}
...
def main():
    ...
    print("\n" + "="*60)
    print(f"  EVAL REPORT: OmniGenV2 + BC + SR (CUB)")
    print("="*60)
