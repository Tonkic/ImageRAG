'''
Evaluation Script for: OmniGenV2 + BC + MGR (ImageNet)
=======================================================
Metrics:
...
# --- 1. Args ---
# --------------------------------------------------
parser = argparse.ArgumentParser(description="Evaluate OmniGenV2_BC_MGR_ImageNet")
...
DATASET_CONFIG = {
    ...
    "results_dir": "results/OmniGenV2_BC_MGR_ImageNet"
}
...
def main():
    ...
    print("\n" + "="*60)
    print(f"  EVAL REPORT: OmniGenV2 + BC + MGR (ImageNet)")
    print("="*60)
